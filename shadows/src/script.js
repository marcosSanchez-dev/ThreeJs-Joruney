...
gui.add(directionalLight.shadow,'radius').min(0).max(50).step(0.001);
...
// Spot light
const spotLight = new THREE.SpotLight('red', 0.3, 10, Math.PI * 0.3)
...
//POINT LIGHTS
const pointLight = new THREE.PointLight('blue',0.3);
