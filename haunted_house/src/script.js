...
const tick = () =>
{
    ...
    ghost2.position.y =  Math.abs(Math.sin(elapsedTime) * 4) + Math.sin(elapsedTime) * 2.5
    ghost2.position.z =  Math.sin(ghost2Angle) * 5

    const ghost3Angle = - elapsedTime * 0.18
    ghost3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.32)) //JUEGAS CON EL RADIUS
    ghost3.position.y = Math.abs(Math.sin(elapsedTime * 4)) + Math.abs(Math.sin(elapsedTime * 2.5))
